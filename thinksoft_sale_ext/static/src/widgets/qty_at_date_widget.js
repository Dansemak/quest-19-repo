...
export class QtyAtDatePopoverExtension extends Component {
  static template = "thinksoft_sale_ext.QtyAtDatePopoverExtension";
  static props = {
    record: Object,
    calcData: Object,
    close: Function,
  ...
  get warehouseName() {
    return this.props.record.data.warehouse_id
      ? this.props.record.data.warehouse_id.display_name
      : _t('All Warehouses');
  }
}

export class QtyAtDateWidgetExtension extends Component {
  static components = { Popover: QtyAtDatePopoverExtension };
  static template = "thinksoft_sale_ext.QtyAtDate";
...
export const qtyAtDateWidgetExtension = {
  component: QtyAtDateWidgetExtension,
  fieldDependencies: [
...
registry.category("view_widgets").add("qty_at_date_widget_ext", qtyAtDateWidgetExtension);
