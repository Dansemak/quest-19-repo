...
class MtrTemplate(models.Model):
    ...
    cr_percent_requirement = fields.Char("Cr% Requirement")
    cr_percent_value = fields.Char("Cr% Value")
    mo_percent_requirement = fields.Char("Mo% Requirement")
    mo_percent_value = fields.Char("Mo% Value")
