...
class MtrTemplate(models.Model):
    ...
    titanium_requirement = fields.Char("Titanium (Ti) Requirement")
    titanium_value = fields.Char("Titanium (Ti) Value")
    iron_requirement = fields.Char("Iron (Fe) Requirement")
    iron_value = fields.Char("Iron (Fe) Value")
    aluminium_requirement = fields.Char("Aluminium (Al) Requirement")
    aluminium_value = fields.Char("Aluminium (Al) Value")
    copper_requirement = fields.Char("Copper (Cu) Requirement")
    copper_value = fields.Char("Copper (Cu) Value")
